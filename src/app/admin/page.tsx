...
export default function DashboardContent() {
    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-white p-4 md:p-8 pb-32 font-sans selection:bg-[#9ECD1D] selection:text-black">
            ...
            >
                <Camera size={32} />
                <span className="absolute bottom-24 right-0 bg-white text-black px-4 py-2 rounded-xl text-[10px] font-smart-detail uppercase opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0 pointer-events-none whitespace-nowrap shadow-xl">
                    Abrir Terminal Facial
                </span>
            </button>
                        ...
                        <div className="space-y-4">
                            {alunosEmRisco.map((aluno, i) => (
                                <div key={i} className="flex items-center justify-between bg-black/40 p-4 rounded-2xl group border border-transparent hover:border-red-500/20 transition-all">
                                    ...
                                    <button className="p-3 bg-white text-black rounded-xl hover:bg-[#9ECD1D] transition-all">
                        ...
                        <div className="space-y-6">
                            {alunosRecuperacao.slice(0, 4).map((aluno, i) => (
                                <div key={i} className="flex items-center justify-between border-b border-zinc-800/50 pb-4 last:border-0 last:pb-0">
                                    ...
                                    <button className="group flex items-center gap-2 text-[9px] font-smart-detail text-[#9ECD1D] uppercase tracking-widest hover:translate-x-1 transition-all">
